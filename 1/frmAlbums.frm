...
Begin VB.Form frmAlbums 
   ...
   Begin MSAdodcLib.Adodc datPrimaryRS 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   "PROVIDER=Microsoft.Jet.OLEDB.3.51;Data Source=D:\data\access\music2.mdb;"
      OLEDBString     =   "PROVIDER=Microsoft.Jet.OLEDB.3.51;Data Source=D:\data\access\music2.mdb;"
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "select * from Albums Order by Name"
      Caption         =   " "
   ...
   Begin MSDataListLib.DataCombo dacArtists 
      Bindings        =   "frmAlbums.frx":08CA
      DataField       =   "Name"
      DataSource      =   "adoArtists"
      Height          =   315
      Left            =   1080
      TabIndex        =   9
      Top             =   480
...
Private Sub dacArtists_Change()
    ...
    lblSelected = dacArtists.SelectedItem
End Sub
...
Private Sub cmdClose_Click()
    If txtFields(0) <> "" Then
        datPrimaryRS.Recordset.Fields("Name") = txtFields(0)
        datPrimaryRS.Recordset.Fields("Artist ID") = lblSelected
